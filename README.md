...
Stable (Maven Central Repository, Released: 28.05.2025 - wait 24hrs for [maven central](http://repo1.maven.org/maven2/de/flapdoodle/testdoc/de.flapdoodle.testdoc/maven-metadata.xml))
